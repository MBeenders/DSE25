...
b_u = 600 # span of upper stage fins [mm]
c_r_u = 750 # root chord length of upper stage fins [mm]
c_t_u = 300 # tip chord length of upper stage fins [mm]
...
L_l = 3660 - L_t - L_u - 5*D_N
A5 = L_l * D_l
X5 = 5*D_N + L_u + L_t + 0.5*L_l

# Segment 6: lower stage fins (assuming at lowest possible point)
b_l = 1200 # span of lower stage fins [mm]
c_r_l = 500 # root chord length of lower stage fins [mm]
c_t_l = 200 # tip chord length of lower stage fins [mm]
A6 = 0.5*b_l*(c_r_l + c_t_l)
X6 = 5*D_N + L_u + L_t + L_l - 0.5*c_r_l

# Initial centre of pressure of the upper stage of the rocket [m]
C_P_u = (A3*X3+A2*X2+A1*X1)/(1000*(A3+A2+A1))
print(C_P_u)

# Initial centre of pressure of the rocket [m]
